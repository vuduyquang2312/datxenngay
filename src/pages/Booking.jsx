...
export default function Booking() {
    ...
    const [destination, setDestination] = useState(''); // Bỏ giá trị mặc định
    const [suggestions, setSuggestions] = useState([]);
    const [debounceTimeout, setDebounceTimeout] = useState(null);
    const [activeInput, setActiveInput] = useState(null); // Đổi thành null để không có input nào active mặc định
    ...
    const handleBookingSubmit = async (bookingData) => {
        try {
            ...
            const response = await fetch('http://36.50.54.222/api/bookings', {
                method: 'POST',
                headers: {
        ...
        <div className="flex w-full  justify-center overflow-y-auto">
            ...
            {isModalOpen && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-white rounded-lg w-full md:w-96 p-6">
                        {/* Header */}
