                ...
                {menuItems.map((item, index) => (
                    ...
                    >
                        <Link
                            ...
                            className={`
                                flex items-center text-xs space-x-6 py-4 rounded-xl p-3 
            ...
            <AnimatePresence>
                ...
                {isMobile && (
                    ...
                    >
                        ...
                        <nav className="flex flex-col p-4 text-xs space-y-2 w-full">
                            {menuItems.map((item, index) => (
                                <motion.div
                                    key={index}
                                    whileHover={{ backgroundColor: "rgb(254,240,138)" }}
                                ...
                                >
                                    <Link
                                        to={item.to}
                                        className={`
                                            flex items-center py-4 texxt-xs space-x-8 rounded-xl p-3 
                                            ${selected === item.to ? 'bg-yellow-200 text-gray-500' : 'text-gray-500'} 
                                            hover:text-gray-500 hover:rounded-xl
                                        `}
                                        onClick={() => {
